#!/usr/bin/env python3
"""
Download HPO ontology (hp.json) from PURL into data/.
Idempotent: skips download if file exists (use --force to re-download).

Usage:
    python scripts/download_hpo.py
    python scripts/download_hpo.py --force
    python scripts/download_hpo.py -o /path/to/dir
"""
